...
if args.GPT3_CoT == 'True':
    column_labels += ['GPT-3 CoT Input',
                      'GPT-3 CoT Output', 'GPT-3 CoT Evaluation']
...
# pode tar estragado por termos corrido o embedding so para um set (ou seja, em vez de [100, 124] passa a [0,24])
# courses_embeddings_indexes = {'18.01': [0, 24], '18.02': [25, 49],
#                              '18.03': [50, 74], '6.042': [75, 99],
#                              '18.05': [100, 124], '18.06': [125, 149],
#                              'COMS3251': [150, 174]}
courses_embeddings_indexes = {'18.05': [0, 24]}
...
def execute_zero_shot(courses, questions_per,
    ...
    for course in courses:
        ...
        course_embeddings = all_embeddings[embeddings_indexes[course]
                                           [0]:embeddings_indexes[course][1]+1]
        questions = []
        answers = []
        ...
        for i in range(questions_per):
            ...
            print('Running Zero-Shot on ' + course +
                  ' question ' + str(i+1) + '...')
            start = time.time()
            ...
            if args.Codex == 'True':
                ...
                codex_input = docstring_front + \
                    context_array[0] + ' ' + prompt_prefix + \
                    ' ' + questions[i] + docstring_back
